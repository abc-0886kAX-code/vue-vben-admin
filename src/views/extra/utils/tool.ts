...
7  * @param {Array} titleArr 导出Excel表头
8  * @param {String} sheetName 导出sheetName名字
9  * @return:
10  */
function exportExcel<T = any>(json: T[], name: String, titleArr: T[], sheetName: String) {
  ...
  const sheetName1: any = sheetName;
